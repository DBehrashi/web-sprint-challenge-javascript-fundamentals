...
/* It's considered nested because it is created inside another function. it has the ability to access the outer variables. No matter where, it has access to the same outer variables. We typically use this to organize our code.
...
console.log(summation(10));
  ...
  */
  ...
  function lowPopulationAnimals(array) {
    const newArrayFilter = array.filter(function (item) {
  ...
  */
  ...
  function USApop(array) {
    const arrayUSApop = array.reduce(function (accumulator, item) {
